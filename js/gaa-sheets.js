(function(){
  ...
  function updateShotMap(rows){
    const cont = document.getElementById('shotMapContainer'); const canvas = document.getElementById('shotScatter'); const overlay = document.querySelector('[data-zone-overlay]');
